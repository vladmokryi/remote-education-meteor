...
Router.map(function() {
    ...
    this.route('test', {
        ...
        waitOn: function () {
            console.log('subscribe');
            return [
                Meteor.subscribe('student.test', this.params._id),
                Meteor.subscribe('student.test.result', this.params._id, Meteor.userId())
            ];
        },
        onBeforeAction: beforeActionStudent
    });

    this.route('testResults', {
        path: '/test/:_id/results',
        waitOn: function () {
            console.log('subscribe');
            return [
                Meteor.subscribe('student.test', this.params._id),
                Meteor.subscribe('students.test.result', this.params._id),
                Meteor.subscribe('admin.students')
            ];
        },
        onBeforeAction: beforeActionTeacher
    ...
    this.route('checkTest', {
        path: '/test/:_id/:userId/check',
        waitOn: function () {
            console.log('subscribe');
            return [
                Meteor.subscribe('student.test', this.params._id),
                Meteor.subscribe('student.test.result', this.params._id, this.params.userId),
                Meteor.subscribe('admin.students')
            ];
        },
        onBeforeAction: beforeActionTeacher
